...
> Task dễ nhất làm trước, khó nhất làm cuối.

| # | Task | Do khi | Kho |
|---|------|--------|-----|
| 1 | Export CSV | Lam truoc | Dễ |
| 2 | CSV Import | Task 1 xong | Dễ |
| 3 | XLSX Import | Task 2 xong | Trung bình |
| 4 | Collocation + RelatedWords (Backend) | Bat dau lam backend | Trung bình |
| 5 | Collocation + RelatedWords (Android) | Task 4 xong | Dễ |
| 6 | Home Dashboard Polish | Task 5 xong | Trung bình |
| 7 | Google Sign-In | Task 6 xong | Khó |
| 8 | Study Mode Integration | Task 7 xong | Trung bình |

---

## :calendar: TASK 1 — Export CSV (DỄ NHẤT)
