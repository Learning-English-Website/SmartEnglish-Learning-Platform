...
export default function SetCard({ set, showActions = false, onEdit, onDelete }) {
      ...
      <div className="set-card__footer">
        ...
        {showActions && (
          <div className="set-card__actions">
            <button className="set-card__btn set-card__btn--edit" onClick={onEdit} title="Sửa">
              <Edit size={14} />
            </button>
            <button className="set-card__btn set-card__btn--delete" onClick={onDelete} title="Xóa">
              <Trash2 size={14} />
            </button>
          </div>
        )}
